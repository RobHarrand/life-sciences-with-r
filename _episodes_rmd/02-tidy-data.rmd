...
![alt text](https://github.com/RobHarrand/life-sciences-spreadsheet-best-practice/tree/gh-pages/fig/01-wide-data.png "Wide data")

Here is the same data restructured in a long format,

![alt text](https://github.com/RobHarrand/life-sciences-spreadsheet-best-practice/tree/gh-pages/fig/02-long-data.png "Long data")
