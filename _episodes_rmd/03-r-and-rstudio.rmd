...
![alt text](https://github.com/RobHarrand/life-sciences-spreadsheet-best-practice/blob/gh-pages/fig/01-r-screen-shot.png "R screen-shot")
...
To allow R to be used for realworld data projects, a program called RStudio is used, which effectively sits ontop of R. This allows the R functionality
...
files and data are bundled together), notebooks (documents with text and code integrated together), presentation slides and interactive apps.

Below us an image of what it looks like,

![alt text](https://github.com/RobHarrand/life-sciences-spreadsheet-best-practice/blob/gh-pages/fig/02-rstudio-screen-shot.png "RStudio screen-shot")
